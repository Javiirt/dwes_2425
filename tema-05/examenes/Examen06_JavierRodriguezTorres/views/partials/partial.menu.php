            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="ordenar.php?criterio=6">Géneros</a></li>
                        <li><a class="dropdown-item" href="ordenar.php?criterio=7">Stock</a></li>
                        <li><a class="dropdown-item" href="ordenar.php?criterio=8">precios</a></li>
                    </ul>
                </li>
