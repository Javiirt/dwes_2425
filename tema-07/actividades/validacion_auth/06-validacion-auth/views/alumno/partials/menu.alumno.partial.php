    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link <?= in_array($_SESSION['role_id'],$GLOBALS['alumno']['nuevo'])? 'active' : 'disabled' ?>" aria-current="page" href="<?= URL ?>alumno/nuevo">Nuevo</a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle <?= in_array($_SESSION['role_id'],$GLOBALS['alumno']['ordenar'])? 'active' : 'disabled' ?>" href="#" role="button" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        Ordenar
                    </a>
            ...
            <!-- protección CSRF -->
                ...
                <!-- botones de accion -->
                <button class="btn btn-outline-primary <?= in_array($_SESSION['role_id'],$GLOBALS['alumno']['filtrar'])? null : 'disabled' ?>" type="submit">Buscar</button>
            </form>
        </div>
    </div>
</nav>