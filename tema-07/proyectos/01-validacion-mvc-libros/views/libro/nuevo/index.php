            ...
            <div class="card-body">
                ...
                <form action="<?= URL ?>libro/create" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <?= (isset($this->error['autor_id'])) ? 'is-invalid' : null ?>" name="autor" required>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select
                        <?= (isset($this->error['editorial_id'])) ? 'is-invalid' : null ?>" name="editorial" required>
                    ...
                    <div class="mb-3">
                        ...
                        <?= (isset($this->error['precio'])) ? 'is-invalid' : null ?>" name="precio" step="0.01"
                            placeholder="0.00" value="<?= htmlspecialchars($this->libro->precio) ?>" required>
                        <!-- mostrar posible error -->
                        <span class="form-text text-danger" role="alert">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control
                        <?= (isset($this->error['unidades'])) ? 'is-invalid' : null ?>" name="unidades" placeholder="0"
                            step="1" value="<?= htmlspecialchars($this->libro->stock) ?>" >
                        <!-- mostrar posible error -->
                        <span class="form-text text-danger" role="alert">
                    ...
                    <div class="mb-3">
                        ...
                        <?= (isset($this->error['fecha_edicion'])) ? 'is-invalid' : null ?>" name="fecha_edicion"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control
                        <?= (isset($this->error['isbn'])) ? 'is-invalid' : null ?>" name="isbn" minlength="13" maxlength="13"
