   ...
   */
    ...
    */
    public function order(int $criterio)
    {
     ...
     /*
        ...
        descripción: vaalida que el dni sea unico
    ...
    */
    ...
    /*
        ...
        descripción: valida que el email sea unico
    ...
    */
    public function validateUniqueEmail($email){
        try {
            ...
            if($stmt->rowCount() != 0) { // si hay registros, no es único
                return false;
            } return true;
    ...
    /*
        ...
        descripción: valida que el curso exista

        @param: id_curso
    */

    public function validateForeignKeyCurso($id_curso){
        try {
